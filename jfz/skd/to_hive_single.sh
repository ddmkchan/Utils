...
if [ $tableName != clickstream ]&&[ $tableName != gxq_app_action_logs ]&&[ $tableName != T_INVEST ]&&[ $tableName != user_combine_fund_shares ]&&[ $tableName != gxq_vir_asset_trading_record ]&&[ $tableName != itc_policy ]&&[ $tableName != jfz_app_logs ]&&[ $tableName != T_GAMBLING_USER_STATS ]&&[ $tableName != ttfund_user_asset ]&&[ $tableName != gxq_scoin_task_record ]&&[ $tableName != gxq_signup_recods ]
then
